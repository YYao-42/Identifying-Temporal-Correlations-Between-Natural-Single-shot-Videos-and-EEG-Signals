function Y = srcProject(data,W)
% Y=SRCPROJECT(DATA3D,W)
%
% data3D: array of epoched data (samples x channels x trials)
% W: matrix of spatial filter weight (channels x component)
%
% Y: spatially filtered "component" data (samples x components x trials)
%
